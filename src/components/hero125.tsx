...
const Hero125 = () => {
  return (
    <section className="relative overflow-hidden py-20 font-sans after:absolute after:bottom-0 after:left-0 after:block after:h-20 after:w-full after:bg-gradient-to-b after:from-transparent after:to-background after:content-[''] md:py-40">
