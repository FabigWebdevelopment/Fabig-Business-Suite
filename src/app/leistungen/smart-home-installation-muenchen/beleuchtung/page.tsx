  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        {/* Pricing CTA Box */}
        <CtaService
          title="Kostenlose Lichtplanung mit 3D-Visualisierung"
          description="Wir erstellen Ihnen kostenlos eine professionelle 3D-Lichtplanung – sehen Sie vorab, wie intelligente Beleuchtung in Ihrem Zuhause aussehen wird!"
          buttonText="Lichtplanung anfragen"
